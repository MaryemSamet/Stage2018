...
import Up from "../Components/Profile/up";
 ...
 class AbonnePage extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          <div> <El1 passedUser={user} /><PageAbonne passedUser={user}/>  <Up /> <El8 /><CopyR />
          </div>
        );
    }
}
...
const connectedAbonnePage = connect(mapStateToProps)(AbonnePage);
export { connectedAbonnePage as AbonnePage };