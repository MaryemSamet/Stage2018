...
import PagePrix from '../Components/PagePrix';
 class PrixPage extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          <div> <El1 passedUser={user} /><PagePrix passedValueAnnonceId={this.state.annonceID} passedUser={user} passedValueUserId={this.state.iduser}/> <Up /> <El8 /><CopyR />
          </div>
        );
    }
}
...
const connectedPrixPage = connect(mapStateToProps)(PrixPage);
export { connectedPrixPage as PrixPage };