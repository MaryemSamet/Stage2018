...
import PageCadeau from '../Components/PageCadeau';
 class CadeauPage extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          <div> <El1 passedUser={user} /><PageCadeau  passedValueAnnonceId={this.state.annonceID} passedUser={user} passedValueUserId={this.state.iduser} /> <Up /> <El8 /><CopyR />
          </div>
        );
    }
}
...
const connectedCadeauPage = connect(mapStateToProps)(CadeauPage);
export { connectedCadeauPage as CadeauPage };