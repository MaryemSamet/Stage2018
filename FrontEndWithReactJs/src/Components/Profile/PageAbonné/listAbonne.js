...
import BottonFollow from "../PageAbonnement/BottonFollow";
 ...
 onLoadMore = () => {
  ...
  render() {
    ...
    return (
      ...
      <div style={{marginTop:'80px',position:'relative'}} ><p align='center' style={{ fontFamily:"Georgia", fontSize:"35px"}}>  <i>All Followers</i> </p>
