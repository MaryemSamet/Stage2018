...
namespace Contact.Controllers
{
    ...
    [Route("api/PropositionServiceCadeau")]
    public class PropositionServiceCadeauController : Controller
    {
        private readonly ExchangeContext _context;

        public PropositionServiceCadeauController(ExchangeContext context)
        {
            _context = context;
        }
